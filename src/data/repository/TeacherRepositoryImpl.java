...
public class TeacherRepositoryImpl implements TeacherRepository {
    ...
    public ResultWrapper<Teacher> save(Teacher teacher) {
        try (PreparedStatement stmt = connection.prepareStatement(QueryConst.UPSERT_TEACHERS)) {
    ...
    public ResultWrapper<Boolean> delete(Teacher teacher) {
        try (PreparedStatement stmt = connection.prepareStatement(QueryConst.DELETE_TEACHER_BY_NATIONAL_ID)) {
    ...
    public ResultWrapper<List<Teacher>> getAll() {
        try (ResultSet resultSet = connection.createStatement().executeQuery(QueryConst.FETCH_ALL_TEACHERS)) {
